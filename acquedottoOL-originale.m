...
N = 2000;                        % DATI DEL PROBLEMA : numero di celle in cui viene suddivisa la conduttura %
deltaX = 5;                      % DATI DEL PROBLEMA : deltaX scelto per la discretizzazione del problema % 
scabrezza = 0.01;                % DATI DEL PROBLEMA : scabrezza conduttura %
Ddato = 0.45;                    % DATI DEL PROBLEMA : diametro conduttura %
c = 407.9;                       % DATI DEL PROBLEMA : celerità delle onde %
...
Tfin=200;
sezval=50;                       % DATI DEL PROBLEMA : sezione nella quale viene posta la valvola %
...
a=0.67;                                                                     % gradi di apertura iniziale della valvola %
...
while T<Tfin
    ...
    Jold=10.29.*(n.^2).*(Qtp.*abs(Qtp))./(D.^(5.33));
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%     
    ...
    if length(indice)==1
       ...
       Apertura(indice,:) = a;
       vetH=[vetH;Hcampionato(1001,indice)];
